document.addEventListener('DOMContentLoaded', () => {
    ...
    document.addEventListener('mousemove', (e) => {
        ...
        // 更新文字 3D 效果，但排除粉丝数框
        const glitchElements = document.querySelectorAll('.glitch, .glitch-subtitle');
    ...
    async function updateFollowerCount() {
        ...
        try {
            ...
            if (lastFollowerCount === null || lastFollowerCount !== follower) {
                console.log('Updating follower count from', lastFollowerCount, 'to', follower);
    ...
    async function fetchStatusAndFollowers() {
        try {
            ...
            followerNumber.textContent = data.follower_count.toLocaleString();
        } catch (error) {
